...
{else}
            ...
            <!-- end left infos-->
            <!-- center infos -->
            <div class="pb-center-column col-xs-12 col-sm-6 col-md-3 col-lg-4">
                {if $product->online_only}
                    <p class="online_only">{l s='Online only'}</p>
                {/if}
                <axseo:h1 itemprop="name">{$product->name|escape:'html':'UTF-8'}</axseo:h1>
                ...
                {if $logged}
                <p class="ean13">EAN13 : {$product->ean13}</p>
                {/if}
                {if $product->description_short || $packItems|@count > 0}
                    ...
                    <!--Accessories -->
                        <section class="page-product-box produit_lie">
                            {* <span class="page-heading">{l s='Nous vous conseillons'}</span> *}
                            <p><strong>Voir les déclinaisons :</strong></p>
                            <div class="ax_productscategory_list clearfix" style="height:150px;">
                                {include file="$tpl_dir./product-list-accessory.tpl" products=$accessories tagtitre="span"}
                            </div>
                        </section>
                    <!--end Accessories -->
                    {/if}
            ...
            <div class="pb-right-column col-xs-12 col-sm-6 col-md-4 col-lg-3">
                {if !$logged}
                    <div class="ax-nolog bg-warning">
                            {l s="Veuillez vous "}<a class="bold" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><strong>{l s="connecter"}</strong></a>
                            {l s="pour accéder au produit"}
                    </div>

                    {elseif isset($clientValide) && $clientValide}
                    <div class="ax-nolog bg-warning"> {l s="Votre compte doit être validé pour passer commande, merci de contacter le"}
                        <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}"> <strong>{l s="service client"}</strong></a>
                    </div>
                            ...
                            <div class="content_prices clearfix">
                                {if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
                                           ...
                                           itemtype="https://schema.org/Offer">{strip}
                                                ...
                                                {if $priceDisplay >= 0 && $priceDisplay <= 2}
                                                    ...
                                                    {if $tax_enabled  && ((isset($display_tax_label) && $display_tax_label == 1) || !isset($display_tax_label))}
                                                        {if $priceDisplay == 1} {l s='(HT)'}{else} {l s='tax incl.'}{/if}
                                                    {/if}
                                                    <meta itemprop="priceCurrency" content="{$currency->iso_code}"/>
                                                    {hook h="displayProductPriceBlock" product=$product type="price"}
                                                {/if}
                                            {/strip}</p>
                                        <p class="qty-mini">{l s='Quantité mini x'}{if isset($axcolisage_multiple)}{$axcolisage_multiple}{elseif $product->unity}{$product->unity}{else}1{/if}</p>
                                    ...
                                    {if !empty($product->unity) && $product->unit_price_ratio > 0.000000}
                                        ...
                                        <p class="unit-price">{l s='Soit'} {convertPrice price=$unit_price} {l s='(HT) le carton'}</p>
                            ...
                            <div class="product_attributes clearfix">
                                ...
                                {if !$PS_CATALOG_MODE}
                                    <p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
                                        ...
                                        <input type="number" name="qty" id="quantity_wanted" class="text form-control"
                                               {if isset($axcolisage_multiple)}min="{$axcolisage_multiple}"
                                               step="{$axcolisage_multiple}" {else}min="1"{/if}
                            ...
                            <div class="box-cart-bottom">
                                <div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
                                    <p id="add_to_cart" class="buttons_bottom_block no-print">
                                        <button type="submit" name="Submit" class="btn btn-blue exclusive">
                ...
                {/if}
                <div class="wrapper-reassurance-produit">
                    <div class="row">
                        <div class="col-xs-4">
                            {if isset($axome.zones.produit_reassurance_1) && $axome.zones.produit_reassurance_1 != ''}
                                {$axome.zones.produit_reassurance_1|displaySvgIcon}
                            {/if}
                        </div>
                        <div class="col-xs-4">
                            {if isset($axome.zones.produit_reassurance_2) && $axome.zones.produit_reassurance_2 != ''}
                                {$axome.zones.produit_reassurance_2|displaySvgIcon}
                            {/if}
                        </div>
                        <div class="col-xs-4">
                            {if isset($axome.zones.produit_reassurance_3) && $axome.zones.produit_reassurance_3 != ''}
                                {$axome.zones.produit_reassurance_3|displaySvgIcon}
                            {/if}
                        </div>
                    </div>
                </div>
        ...
        {if !$content_only}
            ...
            <div class="info-product">
                <ul class="nav" role="tablist">
                    {if isset($product) && $product->description}
                        <li>
                            <a href="#detail-produit" aria-controls="detail-produit" role="tab" data-toggle="tab">
                                {l s='Descriptif produit'}
                            </a>
                        </li>
                    {/if}
                    {if isset($features) && $features}
                        <li>
                            <a href="#caracteristique" aria-controls="caracteristique" role="tab" data-toggle="tab">
                ...
                <div class="tab-content">
                    ...
                    {if isset($product) && $product->description}
                        <div role="tabpanel" class="tab-pane active" id="detail-produit">
                    ...
                    {/if}
                    {if isset($features) && $features}
                        <div role="tabpanel" class="tab-pane {if empty($product->description)}active{/if}"
                             id="caracteristique">
            ...
            {* {if isset($accessories) && $accessories}
                <!--Accessories -->
                <section class="page-product-box ax_productscategory">
                    <span class="page-heading">{l s='Nous vous conseillons'}</span>
                    <div class="ax_productscategory_list clearfix">
                        {include file="$tpl_dir./product-list.tpl" products=$accessories tagtitre="span"}
                    </div>
                </section>
                <!--end Accessories -->
            {/if} *}
